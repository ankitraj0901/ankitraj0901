...
const projects = [
  {
    ...
    description:
      "A full-stack legal-tech platform connecting users with real Chartered Accountants and Lawyers. Features ML-powered tax predictions, AI assistant for filing guidance, and real-time professional consultations.",
    features: [
      "Connect with verified CAs & Lawyers",
      "Real-time chat & document sharing",
      "ML-based taxable income prediction",
      "AI assistant for tax filing guidance",
  ...
  },
  {
    ...
    description:
      "A Machine Learning system performing face detection and recognition using Convolutional Neural Networks. Built end-to-end image preprocessing pipeline with strong focus on feature extraction and model tuning.",
    features: [
      "End-to-end image preprocessing",
      "CNN model design & training",
      "Face classification from unseen images",
  ...
  },
  {
    ...
    tagline: "SVM-Based Healthcare Classification",
    description:
      "A Machine Learning healthcare application predicting diabetes likelihood using patient health metrics. Achieved 97% test accuracy with ROC-AUC score of 0.996 through Support Vector Machine classification.",
    features: [
      "Binary classification with SVM",
      "97% test accuracy achieved",
